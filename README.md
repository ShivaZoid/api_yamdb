...
## Authors
  ...
  - [Yuri Burakh](https://github.com/ShivaZoid/) — Тимлид; Разработчик 2; Создал категории (Categories), жанры (Genres) и произведения (Titles): модели, представления, права доступа и эндпойнты для них; Реализация механизма импорта данных из csv файлов.
