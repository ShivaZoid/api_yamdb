# Generated by Django 3.2 on 2022-12-26 13:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[yamdb.validators.validate_year], verbose_name='Год')),
                ...
                ('genre', models.ManyToManyField(related_name='titles', to='yamdb.Genre', verbose_name='Жанр')),
            ],
            options={
                'verbose_name': 'Title',
